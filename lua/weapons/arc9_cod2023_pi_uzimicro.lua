...
SWEP.Description = ARC9:GetPhrase("")
	or [[Ideal for close-range combat and high mobility. Keep your enemies close with this highly effective, room-clearing pistol with a blazing fire rate.]]
...
SWEP.Animations = {
	...
	["reload"] = {
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_reload_smag_raise.ogg", t = 2 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_magout.ogg", t = 15 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_smag_maghit1.ogg", t = 17 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_smag_maghit2.ogg", t = 28 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_smag_magin.ogg", t = 34 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_smag_end.ogg", t = 41 / 30 },
		},
	},
	["reload_empty"] = {
		Source = "reload_short",
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_raise.ogg", t = 2 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_magout.ogg", t = 14 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_maghit.ogg", t = 41 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_magin.ogg", t = 48 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_rotate.ogg", t = 52 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_grabbolt.ogg", t = 62 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_charge.ogg", t = 62 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_end.ogg", t = 75 / 30 },
		},
	},
	["reload_fast"] = {
		Source = "reload_fast",
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_reload_smag_raise.ogg", t = 0 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_magout.ogg", t = 10 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_smag_maghit2.ogg", t = 12 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_magin.ogg", t = 27 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_end.ogg", t = 30 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_smag_end.ogg", t = 30 / 30 },
		},
	},
	["reload_fast_empty"] = {
		...
		EventTable = {
			...
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_charge_pull.ogg", t = 44 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_charge_release.ogg", t = 49 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_end.ogg", t = 53 / 30 },
		},
	},
	["reload_xmag"] = {
		Source = "reload_xmag",
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_reload_raise.ogg", t = 5 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_magout.ogg", t = 19 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_maghit.ogg", t = 32 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_maghin.ogg", t = 39 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_end.ogg", t = 46 / 30 },
		},
	},
	["reload_xmag_empty"] = {
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_reload_empty_raise.ogg", t = 3 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_ads_magout.ogg", t = 10 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_32rd_mvmnt.ogg", t = 18 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_maghit.ogg", t = 41 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_magslide.ogg", t = 51 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_magin.ogg", t = 53 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_rotate.ogg", t = 58 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_grabbolt.ogg", t = 70 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_charge.ogg", t = 71 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_end.ogg", t = 83 / 30 },
		},
	},
	["reload_xmag_fast"] = {
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_reload_fast_raise.ogg", t = 3 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_magout.ogg", t = 10 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_maghit.ogg", t = 27 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_magin.ogg", t = 33 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_end.ogg", t = 40 / 30 },
		},
	},
	["reload_xmag_fast_empty"] = {
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_raise.ogg", t = 1 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_magout.ogg", t = 8 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_32rd_mvmnt.ogg", t = 21 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_maghit.ogg", t = 28 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_magin.ogg", t = 34 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_ads_boltback.ogg", t = 45 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_ads_boltforward.ogg", t = 50 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_end.ogg", t = 56 / 30 },
		},
	},
	["reload_xmaglrg"] = {
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_reload_32rd_raise.ogg", t = 6 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_32rd_magshit.ogg", t = 18 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_32rd_magout.ogg", t = 19 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_32rd_maghit1.ogg", t = 31 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_32rd_maghit2.ogg", t = 42 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_32rd_magin.ogg", t = 50 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_32rd_end.ogg", t = 59 / 30 },
		},
	},
	["reload_xmaglrg_empty"] = {
		...
		EventTable = {
			...
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_32rd_mvmnt2.ogg", t = 54 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_32rd_rotate.ogg", t = 62 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_32rd_grabbolt.ogg", t = 69 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_32rd_charge.ogg", t = 71 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_32rd_end.ogg", t = 80 / 30 },
		},
	},
	["reload_xmaglrg_fast"] = {
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_reload_fast_32rd_raise.ogg", t = 4 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_32rd_magout.ogg", t = 12 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_32rd_mvmnt.ogg", t = 20 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_32rd_maghit1.ogg", t = 34 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_32rd_maghit2.ogg", t = 39 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_32rd_magin.ogg", t = 44 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_fast_32rd_end.ogg", t = 53 / 30 },
		},
	},
	["reload_xmaglrg_fast_empty"] = {
		...
		EventTable = {
			...
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_32rd_mvmnt2.ogg", t = 50 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_32rd_grabbolt.ogg", t = 55 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_32rd_charge.ogg", t = 55 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_fast_32rd_end.ogg", t = 69 / 30 },
		},
	},
	["ready"] = {
		Source = "draw",
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_raise_first_up.ogg", t = 1 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_charge_pull.ogg", t = 8 / 30 },
			{ s = path .. "p07_pi_uzulum_reload_empty_smag_charge_release.ogg", t = 25 / 30 },
			{ s = path .. "p07_pi_uzulum_raise_first_end.ogg", t = 32 / 30 },
		},
	},
	["draw"] = {
		Source = "draw_short",
		...
		FireASAP = true,
		EventTable = {
			{ s = path .. "p07_pi_uzulum_raise.ogg", t = 0 / 30 },
		},
	},
	["holster"] = {
		Source = "holster",
		EventTable = {
			{ s = path .. "p07_pi_uzulum_drop.ogg", t = 0 / 30 },
		},
	},
	["idle"] = {
		Source = "idle",
	...
	["inspect"] = {
		...
		EventTable = {
			{ s = path .. "p07_pi_uzulum_inspect_raise.ogg", t = 7 / 30 },
			{ s = path .. "p07_pi_uzulum_inspect_rotate1.ogg", t = 39 / 30 },
			{ s = path .. "p07_pi_uzulum_inspect_rotate2.ogg", t = 84 / 30 },
			{ s = path .. "p07_pi_uzulum_inspect_magout.ogg", t = 94 / 30 },
			{ s = path .. "p07_pi_uzulum_inspect_magslide.ogg", t = 132 / 30 },
			{ s = path .. "p07_pi_uzulum_inspect_maghit.ogg", t = 141 / 30 },
			{ s = path .. "p07_pi_uzulum_inspect_magin.ogg", t = 144 / 30 },
			{ s = path .. "p07_pi_uzulum_inspect_end.ogg", t = 151 / 30 },
		},
	},
	["bash"] = {
